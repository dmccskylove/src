...
////@begin dlgArticleEdit event table entries
    ...
    EVT_BUTTON( ID_Apply, dlgArticleEdit::OnApplyClick )
    EVT_UPDATE_UI( ID_Apply, dlgArticleEdit::OnApplyUpdate )
...
////@begin dlgArticleEdit content construction
    ...
    itemBoxSizer12->Add(m_noteBook, 0, wxALIGN_CENTER_HORIZONTAL|wxALL, 5);
    ...
    itemStaticBoxSizer17->Add(itemBoxSizer23, 0, wxALIGN_RIGHT|wxALL, 5);

    wxStdDialogButtonSizer* itemStdDialogButtonSizer24 = new wxStdDialogButtonSizer;

    itemBoxSizer23->Add(itemStdDialogButtonSizer24, 0, wxALIGN_CENTER_VERTICAL|wxLEFT|wxRIGHT|wxTOP, 0);
    wxButton* itemButton25 = new wxButton( itemStaticBoxSizer17->GetStaticBox(), wxID_OK, wxGetTranslation(wxString() + (wxChar) 0x4FDD + (wxChar) 0x5B58), wxDefaultPosition, wxDefaultSize, 0 );
    itemStdDialogButtonSizer24->AddButton(itemButton25);

    wxButton* itemButton26 = new wxButton( itemStaticBoxSizer17->GetStaticBox(), wxID_CANCEL, wxGetTranslation(wxString() + (wxChar) 0x53D6 + (wxChar) 0x6D88), wxDefaultPosition, wxDefaultSize, 0 );
    itemStdDialogButtonSizer24->AddButton(itemButton26);

    itemStdDialogButtonSizer24->Realize();

    wxButton* itemButton27 = new wxButton( itemStaticBoxSizer17->GetStaticBox(), ID_Apply, wxGetTranslation(wxString() + (wxChar) 0x6D4B + (wxChar) 0x8BD5), wxDefaultPosition, wxDefaultSize, 0 );
...
void dlgArticleEdit::OnApplyClick( wxCommandEvent& event )
{
	...
	{
		if(m_idxJPGs<m_arrJPGs.size())	m_idxJPGs++;
		else 											m_idxJPGs = 1;
		c_pgvVisionImage->gvIMG_LoadImage(m_arrJPGs[m_idxJPGs-1]);
